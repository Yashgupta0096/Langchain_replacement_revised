...
def agent_factory():
    ...
    tool_server = ToolServer(
        "tools", url=Config.TOOL_SERVER_URL, api_key=Config.TOOL_SERVER_API_KEY
    )
...
# Assuming Client is defined and imported correctly
client = Client()
...
task = Task(
    ...
    tools=[tool_server],  # Assuming tools should be a list
)
